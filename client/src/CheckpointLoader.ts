...
export class CheckpointLoader {
  ...
  public getCheckpointManifest(): Promise<CheckpointManifest> {
  ...
  // tslint:disable-next-line:member-ordering
  public getAllVariables(): Promise<{[varName: string]: Tensor}> {
  ...
  public getVariable(varName: string): Promise<Tensor> {
